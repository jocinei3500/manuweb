        ...
        <div class="card">
            ...
            <div class="card-header-template">
                <div>
                    ...
                    <a class="btn btn-outline-primary" href="{{ route('ordem-servico.index') }}">listar</a>
                    <a class="btn btn-outline-warning" href="{{ route('app.home') }}">
                ...
                <div class="container-chart">
                    ...
                    <div class="item">
                        <div class="box-conteudo">
                            ...
                            <div class="titulo" style="color: #2174d4;">{{$ordem_servico->descricao}}</div>
                        </div>
                    </div>
                    {{--Box 3--}}
                    <div class="item">
                        ...
                        <div class="col-md-12">
                            <a class="btn btn-outline-primary" href="{{route('Servicos-executado.create',['ordem_servico'=>$ordem_servico->id])}}">
                                <span class="material-symbols-outlined">
                                    post_add
                                </span>Adicionar serviço

                            </a>
                        </div>
                    </div>
                </div>
                <div class="d-grid gap-2 d-sm-flex justify-content float-left">
                    <div class="row mb-1">
                        <div class="col-md-12">
                            <button id="enviar" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#confirmModal">
                                <span class="material-symbols-outlined">
                                    edit_document
                                </span>Fechar Ordem de serviço</button>
                        </div>
                    </div>
                </div>
            </div>
